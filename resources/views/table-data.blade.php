						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									...
									<div class="col-4">
										<a href="#">
											<a class="modal-effect btn btn-primary btn-block" data-effect="effect-flip-vertical" data-toggle="modal" href="#modaldemo8">@lang('lang.Add New Product')</a>
										</a>
									</div>
										...
										<div class="modal-dialog modal-dialog-centered" role="document">
											<div class="modal-content modal-content-demo">
												<div class="modal-header">
													<h6 class="modal-title">@lang('lang.Product Create')</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
												</div>
													...
													<form action="#" method="POST">
														...
														<div>
															<select name="category_type" class="form-control">
																...
																@endphp
																<option value="0">@lang('lang.No Subcategory')</option>
															</select>
														</div>
														<br>
														<div>
