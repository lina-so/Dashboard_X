						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">@lang('lang.Project')</h4>
									
									<div class="col-sm-6 col-md-4 col-xl-3 mg-t-20 mg-md-t-0">
										<a class="btn btn-outline-primary btn-block" href="{{ route('process.create') }}">@lang('lang.Add a new project')</a>
									</div>
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-15p border-bottom-0">@lang('lang.customer name')</th>
												<th class="wd-15p border-bottom-0">@lang('lang.supplier name')</th>
												<th class="wd-15p border-bottom-0">@lang('lang.product')</th>
										...
										<tbody>
											...
											@foreach ($process as $proces)
												...
												<tr>
													...
													<td>{{ __('lang.' .  $prod->product_name) }}</td>													
													<td>

														<!-- the edit function -->
														<a href="process/{{$proces->id}}/edit" class="btn btn-sm btn-info" title="Edit"> <i class="las la-pen"></i></a>
													...
													<td><a href="{{route('proccessStatistics',$proces->id)}}"><button class="btn ripple btn-primary">@lang('lang.view')</button></a></td>
