                        ...
                        <div class="row">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($process as $proces)
                                            ...
                                            <tr>
                                                ...
                                                <div class="row">
                                                    <!-- the edit function -->
                                                    <a href="project/{{$proces->id}}/edit" class="btn btn-sm btn-info" title="Edit" style="margin-left: 2px;"> <i class="las la-pen"></i></a>
                                ...
                                <div class="d-flex justify-content-center">
                                    <a href="{{ url('/doownload/'. $proces->id)}}" class="btn btn-red" style="color: #2136BA">@lang('lang.Sales Contract')</a>
                                    <a href="{{ url('/download/'. $proces->id)}}" class="btn btn-red" style="color: #2136BA">@lang('lang.Purchase Contract')</a>
                                </div> <br>
