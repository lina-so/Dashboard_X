                    ...
                    <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                        <thead>
                            ...
                            <th class="wd-lg-25p tx-right">@lang('lang.ID')</th>
                                ...
                                <th class="wd-lg-25p tx-right">@lang('lang.Base Width')</th>
                                <th class="wd-lg-25p tx-right">@lang('lang.Base Height')</th>
                                <th class="wd-lg-25p tx-right">@lang('lang.Bag Height')</th>
                                <th class="wd-lg-25p tx-right">@lang('lang.Bag Width') </th>
                        ...
                        <tbody>
                        @foreach ($SOSWithoutHandleBag as $item)
                        
                            <tr>
                            <td  class="tx-right tx-medium tx-inverse">{{$item->id}}</td>
                                <td  class="tx-right tx-medium tx-inverse">{{$item->material_color}}</td>
                                <td  class="tx-right tx-medium tx-inverse">{{$item->base_width}}</td>
                                <td  class="tx-right tx-medium tx-inverse">{{$item->base_height}}</td>
                                <td  class="tx-right tx-medium tx-inverse">{{$item->bag_height}}</td>
                                <td  class="tx-right tx-medium tx-inverse">{{$item->bag_width}} </td>
