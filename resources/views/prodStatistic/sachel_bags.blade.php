                    ...
                    <table class="table table-striped table-bordered mb-0 text-sm-nowrap text-lg-nowrap text-xl-nowrap">
                        <thead>
                            ...
                            <th class="wd-lg-25p tx-right">@lang('lang.ID')</th>
                                ...
                                <th class="wd-lg-25p tx-right">@lang('lang.Gusset') </th>
                                <th class="wd-lg-25p tx-right">@lang('lang.Quantity Per Item') </th>
                                <th class="wd-lg-25p tx-right">@lang('lang.Layer Thickness') </th>
                        ...
                        @foreach ($SachalBag as $item)
                            ...
                            <td  class="tx-right tx-medium tx-inverse">{{$item->id}}</td>
                                ...
                                <td  class="tx-right tx-medium tx-inverse">{{$item->gusset}} </td>
                                <td  class="tx-right tx-medium tx-inverse">{{$item->quantity_per_item}}</td>
                                <td  class="tx-right tx-medium tx-inverse">{{$item->pe_layer_thickness}}</td>
