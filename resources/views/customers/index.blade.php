        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0">@lang('lang.Customers Table')</h4>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example" class="table key-buttons text-md-nowrap">
                        <thead>
                            <tr>
                                <th class="border-bottom-0">@lang('lang.Customer Reference')</th>
                                <th class="border-bottom-0">@lang('lang.Customer Organization Name')</th>
                                <th class="border-bottom-0">@lang('lang.Email')</th>
                                <th class="border-bottom-0">@lang('lang.Status')</th>
